...
export class Synth implements ISynth {
  ...
  getOutputAmount(inputAmount: AssetAmount): AssetAmount {
    ...
    const firstSwapOutput = Synth.getSingleSwapOutput(
      inputAmount,
      this.swapPools[0],
    );
  ...
  getInputAmount(outputAmount: AssetAmount): AssetAmount {
    ...
    const secondSwapInput = Synth.getSingleSwapInput(
      outputAmount,
      this.swapPools[1],
    );
  ...
  getSlip = (inputAmount: AssetAmount): Percent => {
    ...
    const secondSlip = Synth.getSingleSwapSlip(
      firstSwapOutput,
      this.swapPools[1],
    );
  ...
  getFee(inputAmount: AssetAmount): AssetAmount {
    ...
    const firstSwapFeeInRune = Synth.getSingleSwapFee(
      inputAmount,
      this.swapPools[0],
    );

    // second swap fee based in output asset
    const secondSwapFeeInAsset = Synth.getSingleSwapFee(
      firstSwapOutput,
      this.swapPools[1],
    );
